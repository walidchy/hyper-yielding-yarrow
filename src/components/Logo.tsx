        ...
        <div className={cn('flex items-center gap-2', logoColor)}>
          ...
          fontFamily: "'Montserrat', 'Cairo', sans-serif"
            ...
            <div className="flex items-center">
              ...
              {!collapsed && <>
                  <div className={cn('ml-1 border-4 rounded-md aspect-square flex items-center justify-center', size === 'sm' ? 'w-6 text-base' : size === 'md' ? 'w-10 text-xl' : 'w-12 text-2xl', logoColor, 'border-current')}>
                    G
                  </div>
                  <div className={cn('ml-1 border-4 rounded-md aspect-square flex items-center justify-center', size === 'sm' ? 'w-6 text-base' : size === 'md' ? 'w-10 text-xl' : 'w-12 text-2xl', logoColor, 'border-current')}>
                    E
